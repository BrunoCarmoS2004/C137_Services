package br.com.c137.project.financial.services.multitenancy.tenant.dtos.posts.servicecontract;
...
public record ServiceContractPostDTO(
        ...
        List<ServiceContractItemPostDTO> serviceContractItems,
